...
struct qt_meta_stringdata_TestKeePass2RandomStream_t {
    QByteArrayData data[4];
    char stringdata0[44];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_TestKeePass2RandomStream_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_TestKeePass2RandomStream_t qt_meta_stringdata_TestKeePass2RandomStream = {
    {
QT_MOC_LITERAL(0, 0, 24), // "TestKeePass2RandomStream"
QT_MOC_LITERAL(1, 25, 12), // "initTestCase"
QT_MOC_LITERAL(2, 38, 0), // ""
QT_MOC_LITERAL(3, 39, 4) // "test"
...
const QMetaObject TestKeePass2RandomStream::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TestKeePass2RandomStream.data,
      qt_meta_data_TestKeePass2RandomStream,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *TestKeePass2RandomStream::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TestKeePass2RandomStream.stringdata0))
