...
QT_MOC_LITERAL(3, 21, 8) // "rejected"

    },
    "EditWidget\0accepted\0\0rejected"
};
...
void EditWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&EditWidget::accepted)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (EditWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&EditWidget::rejected)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject EditWidget::staticMetaObject = {
    { &DialogyWidget::staticMetaObject, qt_meta_stringdata_EditWidget.data,
