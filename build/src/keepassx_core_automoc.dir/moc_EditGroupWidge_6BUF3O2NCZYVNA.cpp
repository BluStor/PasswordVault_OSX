...
QT_MOC_LITERAL(4, 39, 4), // "save"
QT_MOC_LITERAL(5, 44, 6) // "cancel"
...
void EditGroupWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        EditGroupWidget *_t = static_cast<EditGroupWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (EditGroupWidget::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&EditGroupWidget::editFinished)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject EditGroupWidget::staticMetaObject = {
    { &EditWidget::staticMetaObject, qt_meta_stringdata_EditGroupWidget.data,
      qt_meta_data_EditGroupWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *EditGroupWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_EditGroupWidget.stringdata0))
        return static_cast<void*>(const_cast< EditGroupWidget*>(this));
