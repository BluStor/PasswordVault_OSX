...
QT_MOC_LITERAL(1, 13, 19), // "showPasswordChanged"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 4), // "show"
QT_MOC_LITERAL(4, 39, 15), // "setShowPassword"
QT_MOC_LITERAL(5, 55, 16) // "updateStylesheet"

    },
    "PasswordEdit\0showPasswordChanged\0\0"
    "show\0setShowPassword\0updateStylesheet"
};
...
void PasswordEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (PasswordEdit::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PasswordEdit::showPasswordChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject PasswordEdit::staticMetaObject = {
    { &QLineEdit::staticMetaObject, qt_meta_stringdata_PasswordEdit.data,
      qt_meta_data_PasswordEdit,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
