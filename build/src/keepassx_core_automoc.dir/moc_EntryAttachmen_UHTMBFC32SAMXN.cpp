...
const QMetaObject EntryAttachmentsModel::staticMetaObject = {
    { &QAbstractListModel::staticMetaObject, qt_meta_stringdata_EntryAttachmentsModel.data,
      qt_meta_data_EntryAttachmentsModel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
