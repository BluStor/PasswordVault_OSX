...
void InactivityTimer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (InactivityTimer::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&InactivityTimer::inactivityDetected)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject InactivityTimer::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_InactivityTimer.data,
      qt_meta_data_InactivityTimer,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
