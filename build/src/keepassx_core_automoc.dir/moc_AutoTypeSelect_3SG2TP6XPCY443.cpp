...
struct qt_meta_stringdata_AutoTypeSelectView_t {
    QByteArrayData data[3];
    char stringdata0[37];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_AutoTypeSelectView_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_AutoTypeSelectView_t qt_meta_stringdata_AutoTypeSelectView = {
    {
QT_MOC_LITERAL(0, 0, 18), // "AutoTypeSelectView"
QT_MOC_LITERAL(1, 19, 16), // "selectFirstEntry"
...
const QMetaObject AutoTypeSelectView::staticMetaObject = {
    { &EntryView::staticMetaObject, qt_meta_stringdata_AutoTypeSelectView.data,
      qt_meta_data_AutoTypeSelectView,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *AutoTypeSelectView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AutoTypeSelectView.stringdata0))
