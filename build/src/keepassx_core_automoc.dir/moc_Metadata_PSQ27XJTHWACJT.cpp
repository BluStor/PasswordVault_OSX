...
QT_MOC_LITERAL(1, 9, 15), // "nameTextChanged"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 8) // "modified"

    },
    "Metadata\0nameTextChanged\0\0modified"
};
...
void Metadata::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Metadata::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Metadata::nameTextChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Metadata::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Metadata::modified)) {
                *result = 1;
                return;
            }
        }
