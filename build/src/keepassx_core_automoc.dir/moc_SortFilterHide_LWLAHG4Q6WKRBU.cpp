...
const QMetaObject SortFilterHideProxyModel::staticMetaObject = {
    { &QSortFilterProxyModel::staticMetaObject, qt_meta_stringdata_SortFilterHideProxyModel.data,
      qt_meta_data_SortFilterHideProxyModel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SortFilterHideProxyModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SortFilterHideProxyModel.stringdata0))
        return static_cast<void*>(const_cast< SortFilterHideProxyModel*>(this));
