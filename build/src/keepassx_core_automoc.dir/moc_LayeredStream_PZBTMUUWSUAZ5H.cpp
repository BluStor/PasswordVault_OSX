...
void LayeredStream::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        LayeredStream *_t = static_cast<LayeredStream *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject LayeredStream::staticMetaObject = {
    { &QIODevice::staticMetaObject, qt_meta_stringdata_LayeredStream.data,
      qt_meta_data_LayeredStream,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *LayeredStream::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LayeredStream.stringdata0))
        return static_cast<void*>(const_cast< LayeredStream*>(this));
