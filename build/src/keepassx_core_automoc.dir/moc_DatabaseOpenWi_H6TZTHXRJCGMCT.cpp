...
QT_MOC_LITERAL(1, 19, 12), // "editFinished"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 8), // "accepted"
QT_MOC_LITERAL(4, 42, 12), // "openDatabase"
QT_MOC_LITERAL(5, 55, 6), // "reject"
QT_MOC_LITERAL(6, 62, 16), // "activatePassword"
QT_MOC_LITERAL(7, 79, 15), // "activateKeyFile"
QT_MOC_LITERAL(8, 95, 13) // "browseKeyFile"

    },
    "DatabaseOpenWidget\0editFinished\0\0"
    "accepted\0openDatabase\0reject\0"
...
void DatabaseOpenWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (DatabaseOpenWidget::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DatabaseOpenWidget::editFinished)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject DatabaseOpenWidget::staticMetaObject = {
    { &DialogyWidget::staticMetaObject, qt_meta_stringdata_DatabaseOpenWidget.data,
      qt_meta_data_DatabaseOpenWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
